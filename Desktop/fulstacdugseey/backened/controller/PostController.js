...
import cloudanry from "../config/cloudanry.js";
import Post from "../models//PosteModel.js"
...
export const createPost = async (req, res) => {
    ...
    try {
        ...
        if (req.file) {
            ...
            result = await cloudanry.uploader.upload(encodedImage, {
                resource_type: 'image',
...
export const updatePost = async (req, res, next) => {
    try {
        ...
        if (req.file) {
            let encodedImage = `data:image/jpeg;base64,${req.file.buffer.toString('base64')}`;
            const result = await cloudanry.uploader.upload(encodedImage, {
                resource_type: 'image',
                transformation: [
